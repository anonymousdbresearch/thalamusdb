...
CLAP
voices: -28.60293686389923 -28.545427322387695 2776/2802 = ?/46774

netflix movietitle_u
galaxy 0.35367926955223083 0.35388582944869995 406/17770
romantic 0.38638654351234436 0.3868635892868042 282/17770

netflix featured_review_u
positive 14 -0.01698474958539009 -0.01696603186428547 15812/17770

BART
positive 13 0.5379385352134705 0.5380155444145203 8590/17770
"""
ground_truths = {'leather sofa': 27.22, 'desk': 21.71,  # craigslist
                'wooden chair': 23.66, 'dining table': 23.26, 'chair': 22.33,  # craigslist
...
def main():
    ...
    sqls_craigslist = [
    #     "select avg(price) from images, furniture where nl(title_u, 'wood') and images.aid = furniture.aid",
    ...
    sqls_netflix = [
        # "select count(*) from movies, ratings where movies.movieid = ratings.movieid and nl(movietitle_u, 'galaxy')",
        # "select count(*) from movies, ratings where movies.movieid = ratings.movieid and nl(featured_review_u, 'positive')",
        # "select sum(rating) from movies, ratings where movies.movieid = ratings.movieid and nl(featured_review_u, 'positive')",
    ]
